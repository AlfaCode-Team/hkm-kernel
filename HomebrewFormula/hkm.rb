...
class Hkm < Formula
  ...
  url "https://github.com/AlfaCode-Team/hkm-kernel/releases/download/v1.14.0/hkm-kernel-1.14.0-macos-universal.tar.gz"
  sha256 "b647e6b8500473a4252b4e19146c8874e955830171504bb4baeadb360f5b83b8"
  license "MIT"
