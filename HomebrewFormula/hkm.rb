...
class Hkm < Formula
  ...
  url "https://github.com/AlfaCode-Team/hkm-kernel/releases/download/v1.15.0/hkm-kernel-1.15.0-macos-universal.tar.gz"
  sha256 "dc699658066697d1edb6a5bf23947e9b3ea2db68ed25eaa1cc48a3ca18fe6eeb"
  license "MIT"
