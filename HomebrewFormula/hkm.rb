...
class Hkm < Formula
  ...
  url "https://github.com/AlfaCode-Team/hkm-kernel/releases/download/v1.12.1/hkm-kernel-1.12.1-macos-universal.tar.gz"
  sha256 "b3a084229cd890bb9d820023e8578f855b58121e64b4f6c17eb3b7a52732f518"
  license "MIT"
